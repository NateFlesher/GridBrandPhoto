...
class GbMagicShopVC: GbViewController {
                ...
                .items(cellIdentifier: GbCycleCVCell.Identifier,
                       cellType: GbCycleCVCell.self)) {
                        ...
                        cell.photoImageTapHandler = { (c:GbCycleCVCell) in
                            let vc:GbMagicPurchaseVC = self.storyboard?.instantiateViewController(withIdentifier: "MagicPurchaseVC") as! GbMagicPurchaseVC
                            vc.cycle = c.model
                            self.navigationController?.pushViewController(vc, animated: true)
                        }
...
extension GbMagicShopVC: GbCategoryViewDelegate {
...
extension GbMagicShopVC: CLTokenInputViewDelegate {
